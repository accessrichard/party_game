...
const CHANNEL_JOIN_ERROR = 'CHANNEL_JOIN_ERROR';
const CHANNEL_ERROR = 'CHANNEL_ERROR';
const CHANNEL_LEAVE = 'CHANNEL_LEAVE';
const CHANNEL_PUSH = 'CHANNEL_PUSH';
const CHANNEL_RECEIVE = 'CHANNEL_RECEIVE';
const CHANNEL_ON = 'CHANNEL_ON';
const CHANNEL_OFF = 'CHANNEL_OFF';
const CHANNEL_PUSH_OK = 'CHANNEL_PUSH_OK';
const CHANNEL_PUSH_ERROR = 'CHANNEL_PUSH_ERROR';
